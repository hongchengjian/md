...
* [线程](#%E7%BA%BF%E7%A8%8B)
  ...
  * [Java API\-常用方法](#java-api-%E5%B8%B8%E7%94%A8%E6%96%B9%E6%B3%95)
    ...
    * [判断线程有没有持有对象锁Thread\.holdsLock(obj)](#%E5%88%A4%E6%96%AD%E7%BA%BF%E7%A8%8B%E6%9C%89%E6%B2%A1%E6%9C%89%E6%8C%81%E6%9C%89%E5%AF%B9%E8%4%81threadholdslockobj)
    * [控制线程执行顺序Thread\.join( )和多线程的无序执行](#%E6%8E%A7%E5%88%B6%E7%BA%BF%E7%A8%8B%E6%89%A7%E8%A1%8C%E9%A1%BA%E5%BA%8Fthreadjoin-%E5%92%8BF%E7%A8%8B%E7%9A%84%E6%97%A0%E5%BA%8F%E6%89%A7%E8%A1%8C)
...
* [线程池](#%E7%BA%BF%E7%A8%8B%E6%B1%A0)
  ...
  * [线程池参数经验值设置（实际看生产机器）](#%E7%BA%BF%E7%A8%8B%E6%B1%A0%E5%8F%82%E6%95%B0%E7%BB%8F%E9%AA%8C%E5%80%BC%E8%AE%BE%E7%BD%AE%E5%AE%9E%E9%9%9F%E4%BA%A7%E6%9C%BA%E5%99%A8)
  ...
  * [线程池任务在收到某个事件后关闭其中一个线程，其他线程继续执行](#%E7%BA%BF%E7%A8%8B%E6%B1%A0%E4%BB%BB%E5%8A%A1%E5%9C%A8%E6%94%B6%E5%88%B0%E6%9F%90%90%8E%E5%85%B3%E9%97%AD%E5%85%B6%E4%B8%AD%E4%B8%80%E4%B8%AA%E7%BA%BF%E7%A8%8B%E5%85%B6%E4%BB%96%E7%BA%BF%E7%A8%8B%E7%BB%A7%E7%BB%AD%E6%89%A7%E8%A1%8C)
  ...
  * [线程池关闭后的影响](#%E7%BA%BF%E7%A8%8B%E6%B1%A0%E5%85%B3%E9%97%AD%E5%90%8E%E7%9A%84%E5%BD%B1%E5%93%8D)
    * [线程池关闭是否可以接受新任务？](#%E7%BA%BF%E7%A8%8B%E6%B1%A0%E5%85%B3%E9%97%AD%E6%98%AF%E5%90%A6%E5%8F%AF%E4%BB%A5%E6%8E%A5%E5%8F%97%E6%96%B0%E1)
...
* [队列](#%E9%98%9F%E5%88%97)
  ...
  * [LinkedBlockingQueue（newFixedThreadPool） VS LinkedTransferQueue VS LinkedBlockingDeque](#linkedblockingqueuenewfixedthreadpool-vs-linkedtransfereue-vs-linkedblockingdeque)
...
* [Java API\-多线程同步5种方式](#java-api-%E5%A4%9A%E7%BA%BF%E7%A8%8B%E5%90%8C%E6%AD%A55%E7%A7%8D%E6%96%B9%E5%BC%8F)
    ...
    * [2\.synchronized method](#2synchronized-method)
      * [synchronized method == synchronized(this)](#synchronized-method--synchronizedthis)
        ...
        * [synchronized method  flags:  ACC\_SYNCHRONIZED，并没有插入monitorenter、monitorexit](#synchronized-method--flags--acc_synchronized%E5%B9%B6A1%E6%9C%89%E6%8F%92%E5%85%A5monitorentermonitorexit)
    ...
    * [3\.volatile](#3volatile)
      ...
      * [多线程可见性](#%E5%A4%9A%E7%BA%BF%E7%A8%8B%E5%8F%AF%E8%A7%81%E6%80%A7)
        ...
        * [JVM规范定义线程对内存交互操作8个](#jvm%E8%A7%84%E8%8C%83%E5%AE%9A%E4%B9%89%E7%BA%BF%E7%A8%8B%E5%AF%B9%E5%86%85%E5%AD%98%E4%BA%A4%E4%BA%92%E9C8%E4%B8%AA)
...
* [线程切换](#%E7%BA%BF%E7%A8%8B%E5%88%87%E6%8D%A2)
  ...
  * [自愿上下文切换cswch  VS 非自愿上下文切换nvcswch](#%E8%87%AA%E6%84%BF%E4%B8%8A%E4%B8%8B%E6%96%87%E5%88%87%E6%8D%A2cswch--vs-%E9%9D%9E%E8%87%AA%E6%E4%B8%8B%E6%96%87%E5%88%87%E6%8D%A2nvcswch)
...
* [死锁](#%E6%AD%BB%E9%94%81)
  ...
  * [理论\-死锁解决方案](#%E7%90%86%E8%AE%BA-%E6%AD%BB%E9%94%81%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88)
    * [死锁预防(严格破坏OS\-死锁条件四个条件之一)](#%E6%AD%BB%E9%94%81%E9%A2%84%E9%98%B2%E4%B8%A5%E6%A0%BC%E7%A0%B4%E5%9D%8Fos-%E6%AD%BB%E9%94%81%E6%9B%9B%E4%B8%AA%E6%9D%A1%E4%BB%B6%E4%B9%8B%E4%B8%80)
    * [死锁避免(死锁避免比死锁预防允许更多的并发)](#%E6%AD%BB%E9%94%81%E9%81%BF%E5%85%8D%E6%AD%BB%E9%94%81%E9%81%BF%E5%85%8D%E6%AF%94%E6%AD%BB%E9%94%8E5%85%81%E8%AE%B8%E6%9B%B4%E5%A4%9A%E7%9A%84%E5%B9%B6%E5%8F%91)
...
* [锁](#%E9%94%81)
  ...
  * [独享锁(互斥锁，独占锁，写锁， 排它锁EXCLUSIVE，一般是悲观锁) VS 共享锁SHARED(读锁，一般是乐观锁)](#%E7%8B%AC%E4%BA%AB%E9%94%81%E4%BA%92%E6%96%A5%E5%86%99%E9%94%81-%E6%8E%92%E5%AE%83%E9%94%81exclusive%E4%B8%80%E8%88%AC%E6%98%AF%E6%82%B2%E8%A7%82%E9%94%81-vs-%E5%85%B1%E4%BA%AB%E9%94%81shared%E8%AF%BB%E9%94%81%E4%B8%80%E8%88%AC%E6%98%AF%E4%B9%90%E8%A7%82%E9%94%81)
...
* [Redis](#redis)
  ...
  * [架构](#%E6%9E%B6%E6%9E%84)
    ...
    * [集群直联(去中心化)](#%E9%9B%86%E7%BE%A4%E7%9B%B4%E8%81%94%E5%8E%BB%E4%B8%AD%E5%BF%83%E5%8C%96)
  ...
  * [缓存一致性](#%E7%BC%93%E5%AD%98%E4%B8%80%E8%87%B4%E6%80%A7)
    ...
    * [B\.缓存和DB一致性](#b%E7%BC%93%E5%AD%98%E5%92%8Cdb%E4%B8%80%E8%87%B4%E6%80%A7)
      ...
      * [解决方案\-读写分离\+状态机（注意顺序）](#%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88-%E8%AF%BB%E5%86%99%E5%88%86%E7%A6%BB%E7%8A%B6%E6%80%81%E6%9C%BAF%E9%A1%BA%E5%BA%8F)
      * [补充：数据库发生变化，如何及时更新缓存](#%E8%A1%A5%E5%85%85%E6%95%B0%E6%8D%AE%E5%BA%93%E5%8F%91%E7%94%9F%E5%8F%98%E5%8C%96%E5%A6%82%E4%BD%95%6%9B%B4%E6%96%B0%E7%BC%93%E5%AD%98)
...
* [分布式锁](#%E5%88%86%E5%B8%83%E5%BC%8F%E9%94%81)
  ...
  * [Redis分布式锁问题](#redis%E5%88%86%E5%B8%83%E5%BC%8F%E9%94%81%E9%97%AE%E9%A2%98)
    ...
    * [（3）获取锁等待的时间远超过数据库事务超时时间](#3%E8%8E%B7%E5%8F%96%E9%94%81%E7%AD%89%E5%BE%85%E7%9A%84%E6%97%B6%E9%97%B4%E8%BF%9C%E8%B6%85%E8%E%E5%BA%93%E4%BA%8B%E5%8A%A1%E8%B6%85%E6%97%B6%E6%97%B6%E9%97%B4)
...
* [微服务](#%E5%BE%AE%E6%9C%8D%E5%8A%A1)
  ...
  * [分布式自动化测试分布式自动化API文档](#%E5%88%86%E5%B8%83%E5%BC%8F%E8%87%AA%E5%8A%A8%E5%8C%96%E6%B5%8B%E8%AF%95%E5%88%86%E5%B8%83%E5%BC%8F%E8%87%A%96api%E6%96%87%E6%A1%A3)
...
* [Spring](#spring)
  ...
  * [AOP](#aop)
    ...
    * [动态代理两种实现方式适用场景？](#%E5%8A%A8%E6%80%81%E4%BB%A3%E7%90%86%E4%B8%A4%E7%A7%8D%E5%AE%9E%E7%8E%B0%E6%96%B9%E5%BC%8F%E9%80%82%E7%94%A8%EF)
...
* [HTTP](#http)
  ...
  * [TCP 重传、滑动窗口、流量控制、拥塞控制](#tcp-%E9%87%8D%E4%BC%A0%E6%BB%91%E5%8A%A8%E7%AA%97%E5%8F%A3%E6%B5%81%E9%87%8F%E6%8E%A7%E5%88%B6%E6%8B%A5%%E5%88%B6)
* [MQ](#mq)
  ...
  * [Kafka](#kafka)
    ...
    * [ConsumerGroup中新加Consumer、移除Consumer、Consumer崩溃时发生Rebalance](#consumergroup%E4%B8%AD%E6%96%B0%E5%8A%A0consumer%E7%A7%BB%E9%99%A4cons%E5%B4%A9%E6%BA%83%E6%97%B6%E5%8F%91%E7%94%9Frebalance)
    * [Kafka为什么不将offset保存Broker维护？而是在Partition维护？](#kafka%E4%B8%BA%E4%BB%80%E4%B9%88%E4%B8%8D%E5%B0%86offset%E4%BF%9D%E5%AD%98broker%E%E8%80%8C%E6%98%AF%E5%9C%A8partition%E7%BB%B4%E6%8A%A4)
  * [RabbitMQ](#rabbitmq)
    * [模型](#%E6%A8%A1%E5%9E%8B)
    * [顺序消费(RabbitMQ本身缺少顺序消费机制)](#%E9%A1%BA%E5%BA%8F%E6%B6%88%E8%B4%B9rabbitmq%E6%9C%AC%E8%BA%AB%E7%BC%BA%E5%B0%91%E9%A1%BA%E5%BA%8F%E6%%E6%9C%BA%E5%88%B6)
    ...
    * [RabbitMQ的事务（Confirm模式要比事务快10倍）](#rabbitmq%E7%9A%84%E4%BA%8B%E5%8A%A1confirm%E6%A8%A1%E5%BC%8F%E8%A6%81%E6%AF%94%E4%BA%8B%E5%8A%A1%%80%8D)
...
* [JDK](#jdk)
  ...
  * [调优](#%E8%B0%83%E4%BC%98)
    ...
    * [TProfile阿里开源在海量业务代码 精准定位性能代码问题](#tprofile%E9%98%BF%E9%87%8C%E5%BC%80%E6%BA%90%E5%9C%A8%E6%B5%B7%E9%87%8F%E4%B8%9A%E5%8A%A17%B2%BE%E5%87%86%E5%AE%9A%E4%BD%8D%E6%80%A7%E8%83%BD%E4%BB%A3%E7%A0%81%E9%97%AE%E9%A2%98)
...
* [数据库](#%E6%95%B0%E6%8D%AE%E5%BA%93-1)
  ...
  * [存储引擎](#%E5%AD%98%E5%82%A8%E5%BC%95%E6%93%8E)
    * [MySQL支持的存储引擎](#mysql%E6%94%AF%E6%8C%81%E7%9A%84%E5%AD%98%E5%82%A8%E5%BC%95%E6%93%8E)
    * [MySQL不支持的存储引擎](#mysql%E4%B8%8D%E6%94%AF%E6%8C%81%E7%9A%84%E5%AD%98%E5%82%A8%E5%BC%95%E6%93%8E)
...
作者：cj （1）水平有限，请及时指正不对之处（2）不系统、不完善（3）来源于整理、总结、博客
...
3.0之后sharding，无中心网状结构，使用端连接任何一个节点即可，节点动态添加、动态删除不影响集群，端与Redis节点连接不需走Proxy层。半数节点检测到某个节点失效则判定节点失效。

无论cluster还是codis，批量操作mget、mset命令都受限；事务受限
...
```css
JSONString、ToString、StringFormat等任何形式的String涉及命令set、get、setnx、setex、mset、mget、incr、decr。使用场景：热点+时效(1)热点数据：交易行为、库存、商品浏览数、问题、帖子、回复数、点赞数(2)时效信息存储，巧妙利用过期时间：app登陆码30s有效、session防止一个用户多长时间内重复登录、验证码(短信、图形、邮件)
SET
SETNX
SETEX
PSETEX
